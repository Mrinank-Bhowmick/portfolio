      ...
      <div className="bg-zinc-900/40 backdrop-blur-xl h-full w-full border border-white/5 hover:border-gold-500/20 transition-colors duration-500 rounded-[2rem] flex flex-col items-center p-8 xl:p-10 shadow-[0_0_50px_-10px_rgba(0,0,0,0.6)]">
        <div className="flex flex-col gap-6 w-full items-center">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            >
              <FaLinkedin className="w-4 h-4 flex-shrink-0 text-zinc-400 group-hover:text-[#0A66C2] transition-colors" />
            ...
            >
              <FaGithub className="w-4 h-4 flex-shrink-0 text-zinc-400 group-hover:text-white transition-colors" />
              <span className="text-sm font-medium text-zinc-400 group-hover:text-white transition-colors">
                GitHub
              </span>
            </Link>
            ...
            >
              <FaXTwitter className="w-4 h-4 flex-shrink-0 text-zinc-400 group-hover:text-white transition-colors" />
              <span className="text-sm font-medium text-zinc-400 group-hover:text-white transition-colors">
                Twitter/X
              </span>
            </Link>
