    ...
    <div className="py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <Link
          ...
          target="_blank"
          className="group relative flex items-center gap-4 bg-zinc-900/30 border border-white/5 hover:border-gold-500/50 p-6 rounded-2xl transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(245,142,11,0.3)] overflow-hidden"
        >
        ...
        >
          ...
          <div>
            <h3 className="text-white font-semibold text-lg mb-1">GitHub</h3>
            <p className="text-base text-zinc-400 group-hover:text-zinc-300 transition-colors">
              Check my code
            </p>
          </div>
