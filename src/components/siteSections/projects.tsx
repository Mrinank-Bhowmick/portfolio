...
import streaklensImg from "../../../public/streaklens.webp";
import garudaImg from "../../../public/Garuda.jpg";
import resqhealthImg from "../../../public/resqhealth.webp";
import toxicityapi from "../../../public/toxicity-api.jpg";
import verbalize from "../../../public/verbalize.webp";
  ...
  return (
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6 md:gap-8">
        ...
        <Project
          title="Res-Q Health"
          description="An AI-driven healthcare agent for day-to-day conversations, integrating various tools and external services to make better choices in daily consumption. ICDCIT Hackathon finalist project."
        ...
        <div className="group bg-zinc-900/30 border border-white/5 hover:border-gold-500/30 rounded-3xl p-6 sm:p-8 transition-all duration-300 hover:shadow-[0_0_40px_-10px_rgba(245,142,11,0.2)]">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-base text-zinc-400 font-medium mt-0.5">
