  ...
  return (
    <div className="py-8">
      <h2 className="font-bold text-3xl sm:text-4xl text-white mb-12 tracking-tight">
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-gold-600">Education</span>
      </h2>
          ...
          <div className="space-y-12">
            {educationData.map((edu, index) => (
              <div key={index} className="relative flex flex-col sm:flex-row gap-8 sm:gap-12">
                ...
                <div className="flex-1 bg-zinc-900/30 border border-white/5 rounded-2xl p-6 sm:p-8 hover:bg-zinc-900/50 hover:border-gold-500/30 transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(245,142,11,0.2)]">
